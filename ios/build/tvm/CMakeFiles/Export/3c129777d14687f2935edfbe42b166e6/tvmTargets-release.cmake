...
set_target_properties(tvm::tvm PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libtvm.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libtvm.dylib"
  )

list(APPEND _cmake_import_check_targets tvm::tvm )
list(APPEND _cmake_import_check_files_for_tvm::tvm "${_IMPORT_PREFIX}/lib/libtvm.dylib" )
